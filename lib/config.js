...
const ColumnWidth = t.refinement(t.Number, (n) => n % 1 === 0 && n > COLUMN_MIN_WIDTH && n <= COLUMN_MAX_WIDTH, 'ColumnWidth');
...
export function parse(args:Array<String>):Object{
    ...
    const program = require('commander')
        ...
        .option('-f, --format [format]', `output format ${stringEnumeration(OutputFormat)}`, OUTPUT_FORMAT_REGEX, DefaultConfig.format)
